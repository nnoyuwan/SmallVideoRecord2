...
//      FFMpegUtils.captureThumbnails("/storage/emulated/0/DCIM/mabeijianxi/1496455533800/1496455533800.mp4", "/storage/emulated/0/DCIM/mabeijianxi/1496455533800/1496455533800.jpg", "1");
        ...
        MediaRecorderConfig config = new MediaRecorderConfig.Buidler()
                .fullScreen(needFull)//全屏
                .smallVideoWidth(needFull ? 0 : Integer.valueOf(width))//宽度
                .smallVideoHeight(Integer.valueOf(height))//高度
                .recordTimeMax(Integer.valueOf(maxTime))//最长时间
                .recordTimeMin(Integer.valueOf(minTime))//最短时间
                .maxFrameRate(Integer.valueOf(maxFramerate))//帧率
                .videoBitrate(Integer.valueOf(bitrate))//比特率
                .captureThumbnailsTime(1)//截取第一帧
                .build();
        //录制视频
